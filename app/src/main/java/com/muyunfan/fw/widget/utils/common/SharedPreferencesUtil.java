...
public class SharedPreferencesUtil {
    ...
    private static SharedPreferencesUtil sharePref = null;
     ...
     * @return
     */
    public static SharedPreferencesUtil getInstance(String PREF_NAME, Context context) {
        if (sharePref != null) {
            return sharePref;
        } else {
            return sharePref = new SharedPreferencesUtil(PREF_NAME, context);
        }

    }

    /**私有化构造函数并创建SharedPreferences*/
    private SharedPreferencesUtil(String PREF_NAME, Context context) {
