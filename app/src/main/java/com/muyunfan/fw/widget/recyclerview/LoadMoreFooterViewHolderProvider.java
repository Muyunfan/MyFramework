...
public class LoadMoreFooterViewHolderProvider extends ViewHolderProvider<LoadMoreFooterModel,LoadMoreFooterViewHolderProvider.FooterViewHolder> {
    ...
    @Override
    public FooterViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent, @NonNull OnClickByViewIdListener onClickByViewIdListener, @NonNull OnLongClickByViewIdListener onLongClickByViewIdListener) {
